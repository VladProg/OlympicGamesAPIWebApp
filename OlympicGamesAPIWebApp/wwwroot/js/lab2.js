...
function addCategory() {
    ...
    const category = {
        ...
        flagUrl: addInfoTextbox.value.trim(),
    };
...
function displayEditForm(id) {
    ...
    document.getElementById('edit-desctiption').value = category.flagUrl;
...
function updateCategory() {
    ...
    const category = {
        ...
        flagUrl: document.getElementById('edit-desctiption').value.trim()
    };
...
function _displayCategories(data) {
    ...
    data.forEach(category => {
        ...
        imgNode.src = category.flagUrl;
        imgNode.width = 23;
        td2.appendChild(imgNode);
